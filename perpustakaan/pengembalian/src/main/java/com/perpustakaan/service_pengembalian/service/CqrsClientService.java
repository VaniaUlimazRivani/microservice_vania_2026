...
public class CqrsClientService {
    ...
    public Object findById(String entityId) {
        try {
            // Mengambil data spesifik dari CQRS
    ...
    public List<Object> findAll() {
        try {
            // Mengambil semua data dari CQRS
            List<Object> result = restTemplate.getForObject(cqrsUrl + "/api/cqrs/pengembalian/query", List.class);
